...
years he will be twice as old). The answer is always greater or equal to 0, no matter 
if it was in the past or it is in the future.
Fundamentals
Mathematics
*/

//obviously if you import the proper library this can be return abs(dad-(son*2));
